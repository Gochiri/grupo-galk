...
1. **Re-subir las 3 Bases de Conocimiento** a sus bots y verificar que cada una quede
   **asociada** (no solo subida). ⚠️ Esperar a que Claude entregue las **KB v4** (con los
   cambios de fichas: Arequipa-G25, códigos G13/G24/G28, precios de avanzados, requisitos
   de seguridad) para subirlas UNA sola vez.
2. Corregir con **Francisco** el Pack de drywall: texto dice S/850, imagen de reserva dice
   S/890.
